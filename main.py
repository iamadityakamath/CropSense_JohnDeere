...
from routes.llm_council import router as llm_council_router
...
from routes.traditional_ml_prediction import router as traditional_ml_prediction_router
...
app.include_router(llm_council_router)
app.include_router(traditional_ml_prediction_router)
